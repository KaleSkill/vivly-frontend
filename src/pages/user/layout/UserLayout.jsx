...
const UserLayout = () => {
  ...
  const navigation = [
    ...
    { name: 'My Cart', href: '/user/cart', icon: ShoppingCart, current: location.pathname === '/user/cart' },
    { name: 'My Orders', href: '/user/orders', icon: Package, current: location.pathname === '/user/orders' },
    { name: 'Track My Order', href: '/user/track-order', icon: Truck, current: location.pathname === '/user/track-order' },
    { name: 'Addresses', href: '/user/addresses', icon: MapPin, current: location.pathname === '/user/addresses' },
    { name: 'Refunds', href: '/user/refunds', icon: RotateCcw, current: location.pathname === '/user/refunds' },
  ]
